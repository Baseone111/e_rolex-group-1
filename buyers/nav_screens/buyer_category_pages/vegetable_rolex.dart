...
import 'package:new_erolex_app/views/buyers/nav_screens/buyer_category_pages/detailsPage/vegetable_rolex_details_page.dart';

import 'package:provider/provider.dart';

class VegetableRolex extends StatelessWidget {
  const VegetableRolex({super.key});

  Stream<List<Map<String, dynamic>>> _fetchProducts() {
    return FirebaseFirestore.instance
        .collection('Vegetables Rolex')
        .snapshots()
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Vegetables Rolex'),
        actions: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                VegetableRolexDetailsPage(product: product),
                          ),
                        );
                      },
                      child: ClipRRect(
