...
class VegetableRolexDetailsPage extends StatefulWidget {
  final Map<String, dynamic> product;

  const VegetableRolexDetailsPage({super.key, required this.product});

  @override
  _VegetableRolexDetailsPageState createState() =>
      _VegetableRolexDetailsPageState();
}

class _VegetableRolexDetailsPageState extends State<VegetableRolexDetailsPage> {
