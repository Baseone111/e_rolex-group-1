...
class EggRolexDetailsPage extends StatefulWidget {
  final Map<String, dynamic> product;

  const EggRolexDetailsPage({super.key, required this.product});

  @override
  _EggRolexDetailsPageState createState() => _EggRolexDetailsPageState();
}

class _EggRolexDetailsPageState extends State<EggRolexDetailsPage> {
