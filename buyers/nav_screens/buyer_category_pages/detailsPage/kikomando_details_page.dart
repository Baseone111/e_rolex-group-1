...
class KikomandoDetailsPage extends StatefulWidget {
  final Map<String, dynamic> product;

  const KikomandoDetailsPage({super.key, required this.product});

  @override
  _KikomandoDetailsPageState createState() => _KikomandoDetailsPageState();
}

class _KikomandoDetailsPageState extends State<KikomandoDetailsPage> {
