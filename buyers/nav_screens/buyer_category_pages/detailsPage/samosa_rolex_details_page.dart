...
class SamosaRolexDetailsPage extends StatefulWidget {
  final Map<String, dynamic> product;

  const SamosaRolexDetailsPage({super.key, required this.product});

  @override
  _SamosaRolexDetailsPageState createState() => _SamosaRolexDetailsPageState();
}

class _SamosaRolexDetailsPageState extends State<SamosaRolexDetailsPage> {
