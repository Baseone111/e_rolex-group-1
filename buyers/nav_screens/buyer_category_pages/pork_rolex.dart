...
import 'package:new_erolex_app/views/buyers/nav_screens/buyer_category_pages/detailsPage/pork_rolex_details_page.dart';
import 'package:provider/provider.dart';

class PorkRolex extends StatelessWidget {
  const PorkRolex({super.key});
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                PorkRolexDetailsPage(product: product),
                          ),
                        );
                      },
                      child: ClipRRect(
