...
import 'package:new_erolex_app/views/buyers/nav_screens/buyer_category_pages/detailsPage/chicken_rolex_details_page.dart';

import 'package:provider/provider.dart';

class ChickenRolex extends StatelessWidget {
  const ChickenRolex({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Chicken Rolex'),
        actions: [
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                ChickenRolexDetailsPage(product: product),
                          ),
                        );
                      },
                      child: ClipRRect(
