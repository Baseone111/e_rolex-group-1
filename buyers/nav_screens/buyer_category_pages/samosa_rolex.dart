...
import 'package:new_erolex_app/views/buyers/nav_screens/buyer_category_pages/detailsPage/samosa_rolex_details_page.dart';
import 'package:provider/provider.dart';

class SamosaRolex extends StatelessWidget {
  const SamosaRolex({super.key});
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                SamosaRolexDetailsPage(product: product),
                          ),
                        );
                      },
                      child: ClipRRect(
