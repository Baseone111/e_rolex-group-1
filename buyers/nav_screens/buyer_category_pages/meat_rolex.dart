...
import 'package:new_erolex_app/views/buyers/nav_screens/buyer_category_pages/detailsPage/meat_rolex_details_page.dart';

import 'package:provider/provider.dart';

class MeatRolexPage extends StatelessWidget {
  const MeatRolexPage({super.key});
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                MeatRolexDetailsPage(product: product),
                          ),
                        );
                      },
                      child: ClipRRect(
